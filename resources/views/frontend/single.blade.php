                ...
                <div class="col-md-6">
                    <div class="text-center post-entry">
                        ...
                        <div class="text-center post-meta align-items-center">
                            <figure class="mb-0 author-figure me-3 d-inline-block"><img src="{{ asset("storage/$post->image") }}"
                                    alt="Image" class="img-fluid">
                            </figure>
                            <span class="mt-1 d-inline-block">By {{ $post->name }}</span>
        ...
        <div class="container">
            ...
            <div class="row blog-entries element-animate">
                ...
                <div class="col-md-12 col-lg-8 main-content">
                    ...
                    <div class="pt-5">
                        <p>Categories: <a href="#">{{$post->category->slug}}</a>, Tags: <a
                    ...
                    <div class="sidebar-box">
                        <div class="text-center bio">
                            ...
                            <div class="bio-body">
                                ...
                                <p><a href="#" class="px-2 py-2 rounded btn btn-primary btn-sm">Read my bio</a>
                                </p>
                                <p class="social">
